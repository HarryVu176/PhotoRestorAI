...
import { ScissorsIcon, CheckIcon } from './icons';
...
const CropPanel: React.FC<CropPanelProps> = ({ onApplyCrop, onSetAspect, isLoading, isCropping, processingTime = 0, formatProcessingTime }) => {
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-400">Click and drag on the image to select a crop area.</p>
      </div>
      ...
      >
        {isLoading ? (
          <>
            ...
            <span>Processing... {processingTime > 0 && formatProcessingTime && `(${formatProcessingTime(processingTime)})`}</span>
          </>
        ) : (
          <>
